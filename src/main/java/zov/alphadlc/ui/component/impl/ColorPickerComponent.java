...
public class ColorPickerComponent extends Component {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float partialTicks) {
        ...
        DrawUtil.drawText(Fonts.SFREGULAR.get(), setting.getName(), x + 4.5f, y + 3, ColorProvider.rgba(255, 255, 255, alphaInt), 7.5f);
        ...
        DrawUtil.drawRound(previewX - 0.5f, previewY - 0.5f, previewSize + 1, previewSize + 1, 1.5f, ColorProvider.rgba(48, 66, 122, (int)(140 * alpha)));
        ...
        if (openAnim.getValue() > 0.01f) {
            ...
            DrawUtil.drawRound(x + 4.5f, pickerY - 0.5f, width - 9, expandedHeight + 1, 2.5f, ColorProvider.rgba(48, 66, 122, (int)(140 * animAlpha)));
            DrawUtil.drawRound(x + 5, pickerY, width - 10, expandedHeight, 2.5f, ColorProvider.rgba(16, 22, 42, animAlphaInt));
