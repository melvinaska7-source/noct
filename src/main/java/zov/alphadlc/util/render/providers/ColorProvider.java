package zov.alphadlc.util.render.providers;
...
public final class ColorProvider {
	...
	public static int getColorClickGui()           { return ThemeManager.getInstance().getCurrentTheme().colorClickGui; }
	public static int getColorInterfaceBg()        { return ThemeManager.getInstance().getCurrentTheme().colorInterfaceBg; }
