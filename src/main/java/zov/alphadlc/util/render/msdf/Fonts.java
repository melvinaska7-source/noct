package zov.alphadlc.util.render.msdf;
...
public class Fonts {
    ...
    public static final Supplier<MsdfFont> ALPHADLC = Suppliers.memoize(() -> MsdfFont.builder().atlas("alphadlc").data("alphadlc").build());
