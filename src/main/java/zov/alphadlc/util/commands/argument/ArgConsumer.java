...
package zov.alphadlc.util.commands.argument;
...
import zov.alphadlc.util.commands.api.datatypes.IDatatype;
import zov.alphadlc.util.commands.api.datatypes.IDatatypeContext;
import zov.alphadlc.util.commands.api.datatypes.IDatatypeFor;
import zov.alphadlc.util.commands.api.datatypes.IDatatypePost;
...
import zov.alphadlc.util.commands.api.exception.CommandTooManyArgumentsException;
