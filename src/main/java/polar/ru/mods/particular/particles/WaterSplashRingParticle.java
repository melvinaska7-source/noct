...
extends SpriteBillboardParticle {
    ...
    public WaterSplashRingParticle(ClientWorld world, double x2, double y2, double z2, SpriteProvider sprites, double velocityX, double velocityY, double velocityZ) {
    ...
    public void tick() {
        ...
        this.setAlpha(MathHelper.clamp((float)(1.0f - life * 1.15f), (float)0.0f, (float)1.0f));
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x2, double y2, double z2, double velocityX, double velocityY, double velocityZ) {
            return new WaterSplashRingParticle(world, x2, y2, z2, (SpriteProvider)this.sprites, velocityX, velocityY, velocityZ);
        }
    }
}
