...
extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        root.addChild("left_hind_leg", ModelPartBuilder.create().uv(21, 11).cuboid(-0.65f, 2.0f, 0.0f, 1.0f, 2.0f, 1.0f).uv(23, 0).cuboid(-0.65f, 3.0f, -1.0f, 1.0f, 1.0f, 1.0f).uv(8, 19).cuboid(-0.5f, -0.4f, -1.5f, 1.0f, 3.0f, 3.0f), ModelTransform.pivot((float)2.9f, (float)20.0f, (float)2.0f));
        root.addChild("right_hind_leg", ModelPartBuilder.create().uv(0, 18).cuboid(-0.5f, -0.4f, -1.5f, 1.0f, 3.0f, 3.0f).uv(0, 12).cuboid(-0.35f, 2.0f, 0.0f, 1.0f, 2.0f, 1.0f).uv(4, 24).cuboid(-0.35f, 3.0f, -1.0f, 1.0f, 1.0f, 1.0f), ModelTransform.pivot((float)-2.9f, (float)20.0f, (float)2.0f));
        root.addChild("left_front_leg", ModelPartBuilder.create().uv(20, 22).cuboid(-0.55f, 0.0f, -1.0f, 1.0f, 2.0f, 1.0f).uv(12, 12).cuboid(-1.55f, 2.0f, -2.0f, 3.0f, 0.0f, 2.0f), ModelTransform.pivot((float)1.8f, (float)22.0f, (float)-2.0f));
        root.addChild("right_front_leg", ModelPartBuilder.create().uv(22, 5).cuboid(-0.45f, 0.0f, -1.0f, 1.0f, 2.0f, 1.0f).uv(15, 0).cuboid(-1.45f, 2.0f, -2.0f, 3.0f, 0.0f, 2.0f), ModelTransform.pivot((float)-1.8f, (float)22.0f, (float)-2.0f));
        root.addChild("tail", ModelPartBuilder.create().uv(16, 22).cuboid(-0.5f, 0.1f, 0.0f, 1.0f, 4.0f, 1.0f), ModelTransform.of((float)0.0f, (float)20.5f, (float)4.0f, (float)0.9f, (float)0.0f, (float)0.0f));
        ModelPartData tail2 = root.addChild("tail2", ModelPartBuilder.create().uv(0, 0).cuboid(-0.5f, 0.0f, -1.0f, 1.0f, 4.0f, 1.0f), ModelTransform.pivot((float)0.0f, (float)22.0f, (float)7.0f));
        tail2.addChild("tail3", ModelPartBuilder.create().uv(21, 2).cuboid(-0.5f, 0.0f, -1.0f, 1.0f, 2.0f, 1.0f), ModelTransform.pivot((float)0.0f, (float)4.0f, (float)0.0f));
        root.addChild("head", ModelPartBuilder.create().uv(14, 14).cuboid(-2.0f, -1.4f, -4.0f, 4.0f, 4.0f, 4.0f).uv(14, 14).cuboid(-0.5f, 0.75f, -4.3f, 1.0f, 1.0f, 1.0f).uv(0, 24).cuboid(-1.25f, -3.25f, -1.0f, 1.0f, 2.0f, 1.0f).uv(5, 18).cuboid(-2.0f, -3.25f, -1.0f, 1.0f, 2.0f, 1.0f).uv(22, 8).cuboid(0.25f, -3.25f, -1.0f, 1.0f, 2.0f, 1.0f).uv(17, 2).cuboid(1.0f, -3.25f, -1.0f, 1.0f, 2.0f, 1.0f), ModelTransform.pivot((float)0.0f, (float)19.0f, (float)-4.0f));
        ModelPartData body = root.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot((float)0.0f, (float)19.0f, (float)-1.9f));
        body.addChild("body", ModelPartBuilder.create().uv(0, 12).cuboid(-3.25f, 1.9f, -2.1f, 5.0f, 2.0f, 4.0f).uv(0, 0).cuboid(-3.75f, -4.1f, -2.5f, 6.0f, 7.0f, 5.0f), ModelTransform.of((float)0.75f, (float)1.0f, (float)2.0f, (float)1.5708f, (float)0.0f, (float)0.0f));
