...
local PlacementObjectManager = {
    ---コンストラクタ
    ---@return PlacementObjectManager
    new = function ()
        ---@type PlacementObjectManager
        ---@diagnostic disable-next-line: undefined-global
        local instance = MiscUtils.instantiate(PlacementObjectManager, SpawnObjectManager)
    ...
    init = function ()
        ...
        for _, data in ipairs(BlueArchiveCharacter.placementObjects) do
    ...
    getObject = function (self, index, pos, rot)
        if BlueArchiveCharacter.placementObjects[index].placementMode == "MOVE" then
        ...
        ---@diagnostic disable-next-line: undefined-global
        return PlacementObject.new(index, pos, rot)
    end;
