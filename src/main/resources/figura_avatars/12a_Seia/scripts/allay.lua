        ...
        events.TICK:register(function ()
            ...
            if self.isAllayEnabled ~= self.wasAllayEnabledPrev then
                if self.isAllayEnabled then
                    ...
                    models.models.ex_skill_1.Allay:moveTo(ModelAlias.alias.avatar.head)
                    models.models.ex_skill_1:removeChild(ModelAlias.alias.avatar.head.Allay)
                    ...
                    if ModelAlias.alias.avatar.head.Allay ~= nil then
                        ModelAlias.alias.avatar.head.Allay:moveTo(models.models.ex_skill_1)
                        ModelAlias.alias.avatar.head:removeChild(models.models.ex_skill_1.Allay)
                    end
